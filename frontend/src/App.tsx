...
import { enhanceImage, getPresets, getOutputFormats } from './api/enhance';
import type { PresetType, OutputFormat } from './types';
...
function App() {
  ...
  const handleEnhance = async () => {
    ...
    setUIState({ error: null, isLoading: true });
      ...
      <div className="landing-page">
        ...
        <nav className="landing-nav">
          ...
          <div className="nav-right">
            <button className="landing-nav-btn" onClick={() => setShowLandingPage(false)}>
              Try Now
            </button>
          </div>
        </nav>
        ...
        <section className="landing-hero">
          <div className="hero-content">
            ...
            <div className="hero-actions">
              <button className="hero-cta-primary" onClick={() => setShowLandingPage(false)}>
        ...
        <section className="landing-cta">
          <div className="cta-content">
            ...
            <button className="cta-button" onClick={() => setShowLandingPage(false)}>
  ...
  return (
    <div className="app">
      ...
      <nav className="top-nav">
        <div className="nav-left">
          <span className="nav-logo nav-logo-clickable" onClick={() => setShowLandingPage(true)}>
            <span className="logo-icon">✨</span>
            AstroSlide
          </span>
        </div>
      ...
      <footer className="app-footer">
        <div className="footer-content">
          {/* Top Row: Presets */}
          <div className="footer-row footer-row-presets">
            <PresetSelector
              presets={presets}
          ...
          <div className="footer-row footer-row-actions">
            ...
            <div className="footer-section footer-actions">
              ...
              <button 
                ...
                disabled={uiState.isLoading || !imageState.original}
